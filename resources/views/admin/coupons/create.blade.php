        ...
        <form action="{{ route('admin.coupons.store') }}" method="POST" class="space-y-5 text-xs">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="code" required placeholder="e.g. BOISHAKH26 or EID200"
                        value="{{ old('code') }}"
                ...
                <div>
                    ...
                    <select name="type" required
                        ...
                        <option value="percent" {{ old('type') === 'percent' ? 'selected' : '' }}>Percentage Discount (%)
                        </option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="value" required placeholder="e.g. 200 or 15"
                        value="{{ old('value') }}"
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="min_order" placeholder="0 for no minimum"
