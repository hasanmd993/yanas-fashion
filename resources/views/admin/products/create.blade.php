...
@section('content')
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400">Create a new item in your store inventory</p>
        </div>
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="title" required placeholder="e.g. Royal Embroidered Cotton Panjabi"
                        value="{{ old('title') }}"
                ...
                <!-- Title (BN) -->
                <div class="sm:col-span-2">
                    <label class="block font-bold text-gray-700 dark:text-gray-300 mb-1">Alternative Title
                        (optional)</label>
                    <input type="text" name="title_bn" placeholder="e.g. Alternative product title"
                        value="{{ old('title_bn') }}"
                        class="w-full rounded-lg border border-gray-200 dark:border-[#192a43] bg-white dark:bg-[#0e1726] p-3 text-xs font-semibold focus:border-primary focus:outline-none dark:text-white">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="regular_price" required placeholder="4500"
                ...
                <div
                    ...
                    <div class="mt-3 text-gray-400 text-[11px]">
                        ...
                        <input type="text" name="thumbnail" placeholder="/assets/product-embroidered-panjabi.jpg"
                            value="{{ old('thumbnail') }}"
                ...
                <div
                    ...
                    <label class="block font-bold text-gray-800 dark:text-white mb-1">
                        Gallery Extra Images (you may select multiple)
                    </label>
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="sizes" placeholder="M (38), L (40), XL (42), XXL (44)"
                        value="{{ old('sizes') }}"
                        class="w-full rounded-lg border border-gray-200 dark:border-[#192a43] bg-white dark:bg-[#0e1726] p-3 text-xs font-semibold focus:border-primary focus:outline-none dark:text-white">
                </div>
