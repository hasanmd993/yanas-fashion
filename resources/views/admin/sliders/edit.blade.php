        ...
        <form action="{{ route('admin.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="tag" placeholder="e.g. Pohela Boishakh & Festive Edit 2026"
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="title" required placeholder="e.g. Heritage Craft, Modern Elegance"
                ...
                <div
                    class="sm:col-span-2 p-4 rounded-xl bg-gray-50 dark:bg-[#14233c] border border-dashed border-gray-300 dark:border-[#192a43]">
                    ...
                    @if($slider->image)
                        <div class="mb-3">
                            <img src="{{ asset($slider->image) }}" alt="Preview"
                                class="h-24 w-52 rounded-lg object-cover border border-gray-200 dark:border-[#192a43]">
                ...
                <div>
                    ...
                    <input type="text" name="button_text" required placeholder="Explore Collection"
                ...
                <div>
                    ...
                    <input type="text" name="button_link" required placeholder="/shop"
                ...
                <div>
                    <label class="block font-bold text-gray-700 dark:text-gray-300 mb-1">Secondary Button Text
                        (Optional)</label>
                    <input type="text" name="secondary_button_text" placeholder="Panjabi Collection"
                        value="{{ old('secondary_button_text', $slider->secondary_button_text) }}"
                        class="w-full rounded-lg border border-gray-200 dark:border-[#192a43] bg-white dark:bg-[#0e1726] p-3 text-xs font-semibold focus:border-primary focus:outline-none dark:text-white">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="secondary_button_link" placeholder="/shop?category=festive-panjabi"
                        value="{{ old('secondary_button_link', $slider->secondary_button_link) }}"
                        class="w-full rounded-lg border border-gray-200 dark:border-[#192a43] bg-white dark:bg-[#0e1726] p-3 text-xs font-semibold focus:border-primary focus:outline-none dark:text-white font-mono">
                </div>
