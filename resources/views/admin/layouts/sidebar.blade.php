<div :class="{'dark text-white-dark' : $store.app.semidark}">
    <nav class="sidebar fixed bottom-0 top-0 z-50 h-full min-h-screen w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300 bg-white dark:bg-[#0e1726]"
        :class="$store.app.sidebar ? 'left-0 lg:-left-[260px] sidebar-collapsed-desktop sidebar-open-mobile' : '-left-[260px] lg:left-0'">

        <!-- Sidebar Brand Header -->
        <div class="flex items-center justify-between px-5 py-2.5 border-b border-gray-200 dark:border-[#192a43]">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2.5">
                <img src="{{ get_logo_url() }}" alt="Logo"
                    class="h-8 w-8 rounded-lg object-contain bg-white dark:bg-[#1b2e4b] p-0.5 shadow-sm">
                <div>
                    <span
                        class="text-lg font-bold font-serif tracking-tight text-primary dark:text-white">{{ get_setting('site_name', 'Yanas Fashion') }}</span>
                    <span
                        class="block text-[10px] uppercase font-bold tracking-widest text-gray-400 dark:text-gray-500">Admin
                        Control</span>
                </div>
            </a>

            <button type="button" class="lg:hidden text-gray-500 hover:text-primary dark:text-gray-400"
        ...
        <div class="h-[calc(100vh-80px)] overflow-y-auto px-4 py-4">
            <ul class="space-y-1 font-semibold text-gray-600 dark:text-gray-400">
                ...
                <!-- Section: Main -->
                <li
                    class="px-3 pt-2 pb-1 text-[11px] font-extrabold uppercase tracking-wider text-gray-400 dark:text-gray-500">
                    Main Overview
                </li>
                ...
                <li
                    class="px-3 pt-5 pb-1 text-[11px] font-extrabold uppercase tracking-wider text-gray-400 dark:text-gray-500">
