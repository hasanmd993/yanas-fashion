    ...
    <div style="background: var(--bg-light); border-bottom: 1px solid var(--line); padding: 16px 0;">
        <div class="container">
            <div style="display:flex; align-items:center; gap:8px; font-size:0.85rem; color:var(--text-muted);">
                <a href="{{ route('home') }}">হোম</a> <span>/</span>
                <a href="{{ route('shop.index') }}">কালেকশন</a> <span>/</span>
        ...
        <div class="product-detail-layout">
            ...
            <div class="product-detail-info">
                ...
                <div class="sku-stock-row">
                    ...
                    <span>•</span>
                    <span class="in-stock-tag"><i class="fa-solid fa-circle-check"></i> স্টকে আছে (In Stock)</span>
                    <span>•</span>
                    <div class="rating-stars" style="margin-bottom:0;">★★★★★ ({{ $product->reviews_count }} রিভিউ)</div>
                </div>
                ...
                @if($product->sizes && count($product->sizes) > 0)
                    <div class="size-selector-wrap">
                        <div class="size-header">
                            <label>সাইজ নির্বাচন করুন (Select Size):</label>
                            @if($product->size_chart_html)
                                <button type="button" class="size-chart-trigger" id="open-size-chart">
                                    <i class="fa-solid fa-ruler-combined"></i> সাইজ চার্ট গাইড
                                </button>
                            @endif
                        </div>
                ...
                <div class="direct-order-box">
                    <div class="direct-order-head">
                        <h3><i class="fa-solid fa-bolt" style="color:var(--accent);"></i> দ্রুত অর্ডার করতে ফর্মটি পূরণ করুন</h3>
                    </div>
                    ...
                    <form action="{{ route('checkout.store') }}" method="POST" id="direct-order-form">
                        ...
                        <div class="form-group">
                            <label for="direct_name">আপনার নাম *</label>
                            <input type="text" name="customer_name" id="direct_name" class="form-control" placeholder="আপনার সম্পূর্ণ নাম লিখুন" required value="{{ old('customer_name') }}">
                        </div>

                        <!-- Phone -->
                        <div class="form-group">
                            <label for="direct_phone">মোবাইল নম্বর * (১১ ডিজিট)</label>
                        ...
                        <!-- Address -->
                        <div class="form-group">
                            <label for="direct_address">সম্পূর্ণ ঠিকানা * (জেলা, থানা, রোড, বাড়ি নম্বর)</label>
                            <textarea name="customer_address" id="direct_address" class="form-control" placeholder="আপনার বিস্তারিত ঠিকানা লিখুন..." required>{{ old('customer_address') }}</textarea>
                        </div>
                            ...
                            <div class="delivery-zones-grid">
                                ...
                                <label class="zone-option-label">
                                    <div>
                                        ...
                                        <span class="zone-title">ঢাকা উপশহর / সাভার / গাজীপুর</span>
                                    </div>
                                ...
                                <label class="zone-option-label">
                                    <div>
                                        ...
                                        <span class="zone-title">ঢাকার বাইরে সারা বাংলাদেশ</span>
                                    </div>
                ...
                @if($product->description)
                    <div style="margin-top: 36px; padding-top: 24px; border-top: 1px solid var(--line);">
                        <h3 style="font-size: 1.35rem; margin-bottom: 12px;">পণ্যের বিস্তারিত বিবরণ (Product Description)</h3>
        ...
        <div id="size-chart-modal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.6); z-index:3000; align-items:center; justify-content:center; padding:16px;">
            <div style="background:#fff; border-radius:var(--radius-lg); max-width:600px; width:100%; padding:28px; position:relative; box-shadow:var(--shadow-lg); max-height:90vh; overflow-y:auto;">
                ...
                <h3 style="font-size:1.5rem; color:var(--primary); margin-bottom:14px; border-bottom:1px solid var(--line); padding-bottom:8px;">
                    <i class="fa-solid fa-ruler-combined"></i> সাইজ চার্ট গাইড (Size Measurement Guide)
                </h3>
        ...
        <section style="padding: 48px 0; background: var(--white); border-top: 1px solid var(--line);">
            <div class="container">
                <div class="section-head" style="text-align:left;">
                    <span class="eyebrow">সম্পর্কিত পণ্য</span>
                    <h2 class="section-title">আপনার পছন্দ হতে পারে</h2>
                </div>
                        ...
                        <div class="product-card">
                            ...
                            <div class="product-body">
                                ...
                                <div class="card-actions">
                                    <a href="{{ route('checkout.index', ['buy_now' => $rel->id]) }}" class="btn-order-now">অর্ডার করুন</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
